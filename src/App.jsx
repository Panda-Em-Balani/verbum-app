...
const VERSES = [
  ...
  { id:13, ref:"Luke 1:37", text:"For nothing will be impossible for God.", book:"Luke", category:["faith","hope","trust"], explanation:"The angel Gabriel spoke these words to Mary at the Annunciation. It is the great declaration of divine omnipotence, spoken to reassure a young woman asked to do the humanly impossible. In Catholic tradition, this verse is treasured especially in Marian prayer, reminding us that Mary's 'yes' to the impossible is a model for our own surrender to God's will.", example:"When a situation seems beyond all hope, whether a prodigal child, a broken marriage, or an impossible dream, this verse is an anchor." },
  { id:14, ref:"Matthew 5:4", text:"Blessed are they who mourn, for they will be comforted.", book:"Matthew", category:["grief","comfort","hope"], explanation:"This verse comes from the Beatitudes, Jesus' revolutionary re-ordering of what it means to be blessed. In a world that prizes happiness and avoidance of pain, Jesus blesses those who mourn. The word 'comforted' shares a root with Paraclete, which is the Holy Spirit. Our grief is met by the very Spirit of God.", example:"In times of loss, whether death, divorce, or disappointment, this beatitude gives grief its rightful place. The Catholic tradition of All Souls' Day and funeral Masses honors the reality of mourning while pointing always toward comfort and resurrection." },
...
const ROSARY = {
  ...
  Glorious:{day:"Wed & Sun",color:"#EAF0F8",border:"#7898C8",decades:[
    ...
    {name:"Assumption of Mary",ref:"Revelation 12:1",med:"At the end of her earthly life, Mary is assumed body and soul into heavenly glory, the first fruits of the resurrection that awaits us all."},
...
function DailyCatholicHappening() {
  ...
  const HAPPENINGS = [
    ...
    { month:9,  day:8,  emoji:"N", title:"Nativity of the Blessed Virgin Mary", type:"Feast Day", year:"", body:"The Church celebrates the birth of Mary, though Scripture does not record the event. Tradition names her parents as Joachim and Anne. Her birth is the dawn before the rising of the Sun of Justice, Christ himself.", ccc:"The CCC honors Mary as chosen before all ages to be the Mother of God, her birth prepared by God's grace (CCC 490)." },
    ...
    { month:10, day:4,  emoji:"F", title:"Feast of Saint Francis of Assisi", type:"Feast Day", year:"1226", body:"Born into wealth, Francis gave up everything to follow Christ radically, embracing poverty, founding the Franciscans, and receiving the stigmata. His Canticle of the Creatures is one of the earliest poems in Italian literature.", ccc:"The CCC honors Francis as a model of care for creation, reflecting its teaching on the universal destination of goods (CCC 2402)." },
...
const DAILY_VERSES = [
  ...
  { ref:"Luke 1:37", text:"For nothing will be impossible for God.", category:["faith","hope"], explanation:"These are Gabriel's words to Mary at the Annunciation, a great declaration of divine omnipotence, spoken to reassure a young woman asked to do the humanly impossible.", example:"Name the one thing that seems impossible in your life and pray this verse over it." },
  ...
  { ref:"Ephesians 2:10", text:"We are God's handiwork, created in Christ Jesus for the good works that God has prepared in advance.", category:["purpose","faith"], explanation:"The Greek word for handiwork is poiema, which means poem. You are God's poem, composed with care and intention, created for works He already has in mind for you.", example:"Ask God today what good work He has prepared for you and take one step toward it." },
  ...
  { ref:"James 1:17", text:"Every good gift and every perfect gift is from above, coming down from the Father of lights.", category:["gratitude","love"], explanation:"James roots all goodness in God's generous nature. The gifts of life, beauty, love, friendship, and talent are all expressions of the Father's lavish generosity.", example:"Name three good things in your life today and trace them back to God as their source." },
